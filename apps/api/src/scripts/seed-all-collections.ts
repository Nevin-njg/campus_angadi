  ...
  try {
    ...
    if (!buyerProfile) {
      buyerProfile = await UserProfileModel.create({
        ...
        graduationYear: 2028,
        campusRole: 'Student',
        preferredPickupLocation: 'Campus Main Gate',
      })
    }
    ...
    if (!platformSetting) {
      platformSetting = await PlatformSettingModel.create({
        ...
        defaultPickupLocations: ['Campus Main Gate', 'Main campus pickup desk', 'Hostel A Office'],
    ...
    await NotificationModel.insertMany([
      ...
      },
      {
        ...
        message: `Your order CA-2026-0002 is ready for pickup at Campus Main Gate.`,
        referenceType: 'Order',
